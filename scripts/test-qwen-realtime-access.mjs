...
assert.match(session.instructions, /at most one interrogative sentence.*one question mark/i)
...
assert.match(session.instructions, /I did not catch that/i)
assert.match(session.instructions, /unclear-turn repair.*output only those two sentences/i)
assert.match(session.instructions, /never quote.*ASR fragment/i)
assert.match(session.instructions, /do not ask what.*fragment.*meant/i)
assert.match(session.instructions, /do not say Thank you.*unclear/i)
assert.match(session.instructions, /recovery.*do not greet.*Thank you.*same unanswered question/i)
...
assert.match(next.instructions, /at most one interrogative sentence.*one question mark/i)
...
assert.match(next.instructions, /I did not catch that/i)
assert.match(next.instructions, /unclear-turn repair.*output only those two sentences/i)
assert.match(next.instructions, /never quote.*ASR fragment/i)
assert.match(next.instructions, /do not ask what.*fragment.*meant/i)
assert.match(next.instructions, /do not say Thank you.*unclear/i)
...
const opening = qwenResponsePolicy({ intent: 'opening' })
assert.match(opening.instructions, /recovery.*do not greet.*Thank you.*same unanswered question/i)
